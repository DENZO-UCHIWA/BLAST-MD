...
let cc = Config.sessionName.replace(/IZUKU;;;/g, "").replace(/BLAST-MD;;;/gi, ""); // DONT REMOVE BLAST;;; so you can connect BLAST md session id too
